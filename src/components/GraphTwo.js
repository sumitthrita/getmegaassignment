...
const GraphOne = props => {
    ...
    const [pieChartColors, setPieChartColors] = useState(["#fff", "#000", "ff0000", "#cc6600", "#cc9900", "#999966", "#669900", "#00cc00", "#00cc99", "#33cccc", "#33ccff", "#ccccff", "#ff99ff", "#ffff99", "#66ff99", "#9933ff", "#ff9999"])
    ...
    //                 {hoverData[payload[0].payload.name].map((item, i) => {
    //                     return (
    //                         <p className='desc' >
